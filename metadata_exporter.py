...
class MetadataExporter:
    ...
    def export_csv_row(self, metadata: Dict, filename: str, 
        ...
        if 'diffusion' in metadata and 'diffusion_fractions' in metadata['diffusion']:
            for dtype, frac in metadata['diffusion']['diffusion_fractions'].items():
                row[f'frac_{dtype}'] = frac
